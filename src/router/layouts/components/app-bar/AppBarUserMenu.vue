    ...
    <template v-slot:activator="{ on, attrs }">
      ...
      >
        <v-avatar size="40px" v-bind="attrs" v-on="on">
          <v-img :src="require('@/assets/imgs/userOne.jpg')"></v-img>
        </v-avatar>
      </v-badge>
    </template>
    <v-list>
      <div class="pb-3 pt-2">
        ...
        >
          <span class="text--primary font-weight-semibold mb-n1">Lee</span>
      ...
      <v-list-item link>
        <v-list-item-icon class="me-2">
          <v-icon size="22"> mdi-cloud-question </v-icon>
        </v-list-item-icon>
        <v-list-item-content>
      ...
      <v-list-item link>
        <v-list-item-icon class="me-2">
          <v-icon size="22" color="red darken-1"> mdi-logout-variant </v-icon>
        </v-list-item-icon>
        <v-list-item-content>
